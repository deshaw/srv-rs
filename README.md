...
[![Test Status](https://github.com/deshaw/srv-rs/actions/workflows/rust.yml/badge.svg)](https://github.com/deshaw/srv-rs/actions/workflows/rust.yml)
...
```toml
[dependencies]
srv-rs = { version = "0.2.0", features = ["hickory"] }
```
